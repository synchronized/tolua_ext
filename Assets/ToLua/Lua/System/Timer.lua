...
---@param func function 定时器处理函数
---@param duration number 经过时间段(单位:秒)
---@param loop number 循环次数(默认1次,>0代表有限次数,<0代表无限制)
---@param unscaled boolean 是否使用未缩放时间轴
---@return table
